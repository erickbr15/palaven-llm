...
public class BertScoreEvaluationMetricTypeConfiguration : IEntityTypeConfiguration<BertScoreEvaluationMetric>
{
    public void Configure(EntityTypeBuilder<BertScoreEvaluationMetric> builder)
    {
        builder.ToTable("BertScoreEvaluationMetrics", PalavenDbSchemas.Datasets);
