...
public class RagFineTuningBertScoreEvaluationMetricTypeConfiguration : IEntityTypeConfiguration<RagFineTuningBertScoreEvaluationMetric>
{
    public void Configure(EntityTypeBuilder<RagFineTuningBertScoreEvaluationMetric> builder)
    {
        builder.ToTable("RagFineTuningBertScoreEvaluationMetrics", PalavenDbSchemas.Datasets);
