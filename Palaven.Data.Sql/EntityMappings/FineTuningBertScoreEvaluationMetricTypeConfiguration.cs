...
public class FineTuningBertScoreEvaluationMetricTypeConfiguration : IEntityTypeConfiguration<FineTuningBertScoreEvaluationMetric>
{
    public void Configure(EntityTypeBuilder<FineTuningBertScoreEvaluationMetric> builder)
    {
        builder.ToTable("FineTuningBertScoreEvaluationMetrics", PalavenDbSchemas.Datasets);
