...
public class StartIngestTaxLawDocument : ITraceableCommand<IngestLawDocumentModel, IngestLawDocumentTaskInfo>
{
    ...
    {        
        ...
        var lawToIngestDocument = new TaxLawToIngestDocument
        {
            ...
            StartPageExtractionData = inputModel.StartPageExtractionData,
            ChunkSizeExtractionData = inputModel.ChunkSizeExtractionData,
            TotalNumberOfPages = inputModel.TotalNumberOfPages,
